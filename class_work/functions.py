...
#### JANUARY 2020 -- THESE ARE OLD FUNCTIONS I CREATED FOR USE WITH PANDAS DATAREADER AND THE IEX CLOUD;
#### THEY SERVE TO PARSE DATA FROM A JSON-BASED API; CREATE VISUALIZATIONS USING MATPLOTLIB; AND IDENTIFIY TREND-REVERSALS

#### SHOULD BE THE SAME AS THE JUPYTER NOTEBOOK OF THE SAME NAME
